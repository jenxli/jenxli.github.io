...
const projectData = [
    {
        ...
        longDescription: ['An interactive genomic variant visualization and analysis program.', 'Variant Graph Craft (VGC) offers a wide range of features for exploring genetic variations, including the ability to extract variant data, visualize variants and provide a graph representation of samples along with genotype data. '],
        image: vgc,
    ...
    },
    {
        ...
        longDescription: ['A deep learning architecture to label American Sign Language (ASL) fingerspelling from (1) static images and (2) real time footage.', 'The final project for CSCI 1470: Deep Learning, and a collaboration project by Grace Wan, Kyle Lam, Claire Yang, and Jennifer Li. '],
        image: asl,
